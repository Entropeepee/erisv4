...
try:
    ...
    # Check if Elderboom is already spawned
    existing = [a for a in actor_subsystem.get_all_level_actors() if "Elderboom" in a.get_actor_label()]
    if not existing:
    ...
    if bp_natalia_asset:
        ...
        if eris:
            ...
            try:
                ...
                unreal.log_warning(f"Possess properties error: {pe}")
